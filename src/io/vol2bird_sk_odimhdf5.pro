;
;IDL routine to read hdf5 radar files in ODIM format from Slovakia
;
;Author: M. de Graaf (KNMI)
;Date: April 2012
;

PRO vol2bird_sk_odimhdf5
  ;
  ;Call  
  ;
  ; RESOLVE_ROUTINE, 'vol2bird_sk_odimhdf5', /compile_full_file
  ;
  ...
  ; (e.g. vol2bird_sk_odimhdf5_read_scan for the scan read procedure)
...
END
;
PRO vol2bird_sk_odimhdf5_get_datetime,file,this_date,this_time
;
...
this_time=STRMID(FILE_BASENAME(file),14,6)
;
END
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_sk_odimhdf5_read_scan, 	$
...
;
vol2bird_sk_odimhdf5_get_datetime,h5infile,this_date,this_time
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_sk_odimhdf5_read_cluttermap,h5cluttermap,cmmeta,cmscan
;
COMMON constants
;
make_meta,cmmeta
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_sk_odimhdf5_write_profile,     $
h5outfile,in,	    	    	    	    $
success=success,    	    	    	    $
vmeta,zmeta,uzmeta,   	    	    	    $

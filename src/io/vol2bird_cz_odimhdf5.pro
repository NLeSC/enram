;
;IDL routine to read ODIM hdf5 radar files from czech republic
;
;Author: M. de Graaf (KNMI)
;Date: April 2012
;

PRO vol2bird_cz_odimhdf5
  ;
  ;Call  
  ;
  ; RESOLVE_ROUTINE, 'volbird_cz_odimhdf5', /compile_full_file
  ;
  ...
  ; (e.g. vol2bird_cz_odimhdf5_read_scan for the scan read procedure)
...
END
;
PRO vol2bird_cz_odimhdf5_get_datetime,file,this_date,this_time
;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_cz_odimhdf5_read_scan, 	$
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;IN czech format, the different data products are scattered over several files, 
...
dt_strstart=STRPOS(passed_file,'C_OKPR_')+7
thisdatetime=STRMID(passed_file,dt_strstart,14)
;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_cz_odimhdf5_read_cluttermap,h5cluttermap,cmmeta,cmscan
;
COMMON constants
;
make_meta,cmmeta
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_cz_odimhdf5_write_profile,     $
h5outfile,in,	    	    	    	    $
success=success,    	    	    	    $
vmeta,zmeta,uzmeta,   	    	    	    $

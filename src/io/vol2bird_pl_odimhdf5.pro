;
;IDL routine to read hdf5 radar files in ODIM format from Norway
;
;Author: M. de Graaf (KNMI)
;Date: April 2012
;

PRO vol2bird_pl_odimhdf5
  ;
  ;Call  
  ;
  ; RESOLVE_ROUTINE, 'vol2bird_pl_odimhdf5', /compile_full_file
  ;
  ...
  ; (e.g. vol2bird_pl_odimhdf5_read_scan for the scan read procedure)
...
END
;
PRO vol2bird_pl_odimhdf5_get_datetime,file,this_date,this_time
;
IF SIZE(file[0],/TYPE) ne 7 THEN BEGIN
  PRINT, 'please, provide a string (array) of filename(s)'
  stop
ENDIF
this_date=STRMID(FILE_BASENAME(file),7,8)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_pl_odimhdf5_read_scan, 	$
...
this_code=STRMID(filebase,3,3)
thisdatetime=STRMID(filebase,7,14)
;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_pl_odimhdf5_read_cluttermap,h5cluttermap,cmmeta,cmscan
;
COMMON constants
;
make_meta,cmmeta
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_pl_odimhdf5_write_profile,     $
h5outfile,in,	    	    	    	    $
success=success,    	    	    	    $
vmeta,zmeta,uzmeta,   	    	    	    $

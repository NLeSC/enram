;
;IDL routine to read hdf5 radar files in ODIM format from Slovenia
;
;Author: M. de Graaf (KNMI)
;Date: April 2012
;

PRO vol2bird_si_odimhdf5
  ;
  ;Call  
  ;
  ; RESOLVE_ROUTINE, 'vol2bird_si_odimhdf5', /compile_full_file
  ;
  ...
  ; (e.g. vol2bird_si_odimhdf5_read_scan for the scan read procedure)
...
END
;
PRO vol2bird_si_odimhdf5_get_datetime,file,this_date,this_time
;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_si_odimhdf5_read_scan, 	$
...
vol2bird_si_odimhdf5_get_datetime,filebase,this_date,this_time
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_si_odimhdf5_read_cluttermap,h5cluttermap,cmmeta,cmscan
;
COMMON constants
;
make_meta,cmmeta
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_si_odimhdf5_write_profile,     $
h5outfile,in,	    	    	    	    $
success=success,    	    	    	    $
vmeta,zmeta,uzmeta,   	    	    	    $

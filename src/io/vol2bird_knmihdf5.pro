...
PRO vol2bird_knmihdf5
  ...
  ; (e.g. vol2bird_knmihdf5_read_scan for the scan read procedure)
...
END
;
PRO vol2bird_knmihdf5_get_datetime,file,this_date,this_time
;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_knmihdf5_read_scan,    	$
...
IF N_PARAMS() eq 5 THEN BEGIN
  ...
  ENDIF
  ;
  ;CREATE a ODIM compatible structure
  ;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_knmihdf5_read_cluttermap,h5cluttermap,cmmeta,cmscan
;
COMMON constants
;
make_meta,cmmeta
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;PRO vol2bird_knmihdf5_write_profile,h5outfile,in,	    $
;hdata,udata,vdata,wdata,xdata,zdata,nndata, $
;cellmap,vtex,VTEXSCALE,VTEXOFFSET,NLEV,     $
;MISSING,imgflag

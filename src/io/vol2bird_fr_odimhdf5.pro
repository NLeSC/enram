;
;IDL routine to read hdf5 radar files in ODIM format from France
;
;Author: M. de Graaf (KNMI)
;Date: April 2013
;

PRO vol2bird_fr_odimhdf5
  ;
  ;Call  
  ;
  ; RESOLVE_ROUTINE, 'vol2bird_fr_odimhdf5', /compile_full_file
  ;
  ...
  ; (e.g. vol2bird_fr_odimhdf5_read_scan for the scan read procedure)
...
END
;
PRO vol2bird_fr_odimhdf5_get_datetime,file,this_date,this_time
;
...
ENDIF
;
this_date=STRMID(FILE_BASENAME(file),17,8)
this_time=STRMID(FILE_BASENAME(file),25,4)
;
END
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_fr_odimhdf5_read_scan, 	$
...
this_code=STRMID(filebase,13,3)
thisdatetime=STRMID(filebase,17,12)
thisdate=STRMID(thisdatetime,0,8)
thistime=STRMID(thisdatetime,8,4)
;
...
FOR iscan=beginscan,endscan DO BEGIN
  ...
  meta[iscan].date=thisdate
  meta[iscan].time=thistime
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_fr_odimhdf5_read_cluttermap,h5cluttermap,cmmeta,cmscan
;
COMMON constants
;
make_meta,cmmeta
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
PRO vol2bird_fr_odimhdf5_write_profile,     $
h5outfile,in,	    	    	    	    $
success=success,    	    	    	    $
vmeta,zmeta,uzmeta,   	    	    	    $

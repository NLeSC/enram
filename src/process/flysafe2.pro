;
;FLYSAFE 2. Extract Bird density profiles from European weather radar data
;
cluttermap=1
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
IF KEYWORD_SET(ultra_test) THEN BEGIN
  ;
  day0 = 01
  month0 = 09
  year0 = 2011
...
;FIUTA','FIVAN','FIVIM','FRABB','FRALE','FRTRO','FRAVE','FRBLA','FRBOL','FRBOR','FRBOU','FRCAE','FRCHE','FRCOL','FRGRE','FRMOM','FRMTC','FRMCL','FRNAN','FRNIM','IEDUB','IESHA','NLDBL','NLDHL','NOAND','NOBML','NOHAS','NOHGB','NOHUR','NORSA','NORST','NOSTA','PLBRZ','PLGDA','PLLEG','PLPAS','PLPOZ','PLRAM','PLRZE','PLSWI','SEVIL','SEVAR','SEOVI','SEOSU','SELUL','SELEK','SEKKR','SEKIR','SEHUD','SEASE','SEARL','SEANG','SILIS','SKMAJ','SKKOH']
  ...
  IF cluttermap THEN BEGIN
    ...
    FOR iclutter =0,N_ELEMENTS(clutter_ids)-1 DO BEGIN
      ...
      CASE clutter_id of
       ...
       -1 : clutter_definition = 'MODE'
       -2 : clutter_definition = 'MEDIAN'

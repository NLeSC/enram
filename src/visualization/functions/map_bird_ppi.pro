...
FOR ifile=0,N_ELEMENTS(files)-1 DO BEGIN
  ;
  get_bird_ppi,files[ifile],image,limit=ppilimit,$
  rain=rain,fringe=fringe,$
  io_file=definitions[ifile].io_file,$
  radar_loc=radar_loc,scan=scan,elevation=elevation,$
  dx=dx,maxr=maxr,maxz=maxz,meta=meta
  ;
...
thedatestring=STRING(FORMAT='(a2,"-",a2,"-",a4,", ",a2,":",a2," UTC ")',DD,MM,YY,hh,mi)
